...
public class StringUtil {
	...
	/*
	 * public static String readString(DataInput input) throws IOException { if
	 * (optimizeStrings) { StringUtilBuffer buffer = getBuffer(); return
	 * readString(input,buffer); } else { return input.readUTF(); } }
	 */
