...
public class ClassMetaData implements ClassMetaConsts {
	...
	/**
	 * Used to reconstruct the Ghost Constructor used by Serialization's
	 * specification
	 */
	...
	private static Constructor findConstructor(Class clazz) throws NoSuchMethodException {
		...
		// I don't expect this exceptiong being thrown unless the JVM doesn't
		// support reflection at al
