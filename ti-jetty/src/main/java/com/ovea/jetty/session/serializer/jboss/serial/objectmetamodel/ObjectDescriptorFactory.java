...
public class ObjectDescriptorFactory implements ClassMetaConsts {
	static Object objectFromDescription(final ObjectsCache cache, ObjectsCache.JBossSeralizationInputInterface input) throws IOException {
	...
	private static Object objectFromDescriptionInternal(final ObjectsCache cache, ObjectsCache.JBossSeralizationInputInterface input) throws IOException {
	 ...
	 * readObjectDescriptionFromStreaming. If it was already loaded, it will
	 * just return from objectCache
	 */
	...
	private static Object readObjectDescriptionFromStreaming(final ObjectsCache cache, ObjectsCache.JBossSeralizationInputInterface input) throws IOException {
		int reference = input.readObjectReference();
