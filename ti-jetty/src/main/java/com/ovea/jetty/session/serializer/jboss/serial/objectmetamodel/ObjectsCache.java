...
public class ObjectsCache extends DataExport implements ClassMetaConsts {
	...
	/**
	 * This doesn't need a weakHashMap as this is the temporary object
	 * serializable cache. It will be released as soon as the streaming is
	 * closed. HashMap<Class, TObjectIntHashMap>
	 */
