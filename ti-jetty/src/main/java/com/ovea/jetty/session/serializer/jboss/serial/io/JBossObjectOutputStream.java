...
public class JBossObjectOutputStream extends ObjectOutputStream implements DataContainerConstants {
	...
	/**
	 * one of the optimizations we do is to reuse byte arrays on writeUTF
	 * operations, look at {@link org.jboss.serial.util.StringUtil}. StringUtil
	 * has also the capability of creating Buffers on ThreadLocal over demand,
	 * but having these buffers pre-created is more efficient
	 */
	...
	/**
	 * Reuses every primitive value to recreate another object. and if
	 * safeToReuse!=null, it can reuse the entire object
	 */
